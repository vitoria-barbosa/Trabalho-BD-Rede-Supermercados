...
BEGIN 
	...
	CASE LOWER(P_TABELA)
		...
		WHEN 'venda' THEN
			F_SQL := FORMAT('INSERT INTO VENDA(ID_CLI, ID_FUNC, ID_PAG) VALUES (%s)', VALORES);
		WHEN 'item_venda' THEN
			...
			F_SQL := FORMAT('INSERT INTO ITEM_VENDA (ID_ESTOQUE, ID_VENDA, QTD_VENDIDA) VALUES (%s)', VALORES);
		ELSE
...
SELECT INSERIR('ITEM_VENDA', '6', 'FARINHA DE TRIGO', '1', '1')
